...
export const ProgressDisplay = React.memo<ProgressDisplayProps>(
  ({ progress, stage, estimatedTime, showDetails = false, className }) => {
    return (
      <div className={cn('space-y-8 p-6', className)}>
        ...
        <div className='deployment-card p-8'>
          <div className='flex flex-col items-center space-y-8'>
            {/* Circular Progress */}
            <ProgressCircle progress={progress} size={120} showPercentage={true} />
          ...
          <div className='deployment-card p-6'>
            <div className='space-y-4'>
              <div className='flex justify-between items-center'>
                ...
                <div className='flex items-center gap-2'>
                  <span className='text-xs text-muted-foreground'>
                    {m['ide.deployment.status.progressWord']()}
                  </span>
              ...
              <div className='space-y-3'>
                <Progress value={progress} className='h-3 bg-muted/50 shadow-inner' />
            ...
            <div className='flex items-start gap-4'>
              ...
              <div className='flex-1 space-y-2'>
                <h3 className='text-sm font-semibold text-foreground'>
                  {m['ide.deployment.progress.deploymentTime']()}
                </h3>
                <p className='text-sm text-muted-foreground leading-relaxed'>{stage}</p>
                ...
                {estimatedTime && (
                  <div className='text-xs text-muted-foreground'>
                    {m['ide.deployment.status.estimatedTimeRemainingWithValue']({ estimatedTime })}
                  </div>
                )}
              </div>
            </div>
