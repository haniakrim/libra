...
export function DeploymentDialog({
  ...
  const renderCurrentStage = () => {
    switch (currentStage) {
      case 'progress':
        return <DeploymentProgress deployProgress={deployProgress} deployStage={deployStage} />
      case 'success':
        return (
          <DeploymentSuccess
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <DialogTitle
          ...
          className={stageConfig.showHeader ? 'sr-only' : 'sr-only'}
        >
          {dialogTitle}
        </DialogTitle>
        <DialogDescription
          id='deployment-dialog-description'
          className={stageConfig.showHeader ? 'sr-only' : 'sr-only'}
        >
          {dialogDescription}
        </DialogDescription>
        ...
        <DeploymentErrorBoundary>
          <div
            className='deployment-modal overflow-hidden
